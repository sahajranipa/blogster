      ...
      <div className="font-headingFont text-center">
        ...
        <div className="flex flex-col w-[60%] space-y-3 mx-auto mt-5 border border-gray-300 rounded-xl p-7 shadow-xl text-left">
          ...
          <p className="font-bodyFont text-balance">
            ...
            curious minds who are passionate about learning, sharing, and
            connecting. Whether you're here to read, write, or simply explore,
        ...
        <div className="flex flex-col space-y-3 w-[60%] mx-auto mt-5 bg-black text-white border border-gray-300 rounded-xl p-7 shadow-xl text-left">
          ...
          <p className="font-bodyFont text-balance">
            ...
            thought-provoking opinion pieces, Blogster covers a wide range of
            topics to keep you informed, entertained, and inspired. Dive into
            our carefully curated articles and discover stories that resonate
            with you.
          </p>
        </div>
        ...
        <div className="flex w-[60%] flex-col gap-3 mx-auto">
          <div className="flex flex-col space-y-3  mx-auto mt-5 bg-black text-white border border-gray-300 rounded-xl p-7 shadow-xl text-left">
            ...
            <p className="font-bodyFont">
              ...
              favorite posts, and start meaningful conversations. Our mission is
              to create a space where ideas flow freely, and everyone feels
          ...
          <div className="flex flex-col space-y-3  mx-auto mt-5 bg-black text-white border border-gray-300 rounded-xl p-7 shadow-xl text-left">
            ...
            <p className="font-bodyFont">
              ...
              on social media to stay updated with trending topics, featured
              writers, and more.
            </p>
