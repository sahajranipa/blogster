...
const RelatedBlogsContainer = () => {
  return (
    <div className="flex flex-col w-[80%] gap-4 aspect-square items-start justify-start mb-12 md:mb-10">
      <Image
        ...
        className="object-cover w-full md:w-[80%] aspect-square rounded-md"
      />
